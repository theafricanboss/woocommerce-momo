    ...
    if ( $pagenow == 'admin.php' || $pagenow == 'index.php' ) {
		...
		if ( in_array( 'administrator', (array) $user->roles ) ) {
			 echo '<div class="notice notice-info is-dismissible">
				 ...
				 <p><a href="https://wordpress.org/support/plugin/momo-mobile-money-payments-woocommerce-extension/reviews/?filter=5" target="_blank"><img src="https://theafricanboss.com/wp-content/uploads/2020/05/momo_button.png" width="200px" height="auto"></a></p></div>
			 </div>';
		}
	}
}
...
function momo_admin_menu(){
	add_menu_page( null , '<span style="color:yellow">MOMO</span>' , 'manage_options' , 'wc-settings&tab=checkout&section=momo' , 'momo_admin_menu' , 'dashicons-money-alt' );
	add_submenu_page( 'wc-settings&tab=checkout&section=momo' , 'Review MOMO' , '<span style="color:yellow">Review >> </span>' , 'manage_options' , 'https://wordpress.org/support/plugin/momo-mobile-money-payments-woocommerce-extension/reviews/?filter=5' , null, null );
	add_submenu_page( 'wc-settings&tab=checkout&section=momo' , 'Our Plugins' , 'Our Plugins' , 'manage_options' , 'https://profiles.wordpress.org/theafricanboss/#content-plugins' , null, null );
	...
	class WC_MOMO_Gateway extends WC_Payment_Gateway {
		...
		public function thankyou_page( $order_id ) {
    		...
    		if ( 'momo' === $order->get_payment_method() ) {
    			if ( $this->momo_notice ) {
    				echo '<h2>MOMO Notice</h2>' , wp_kses_post( wpautop( wptexturize( $this->momo_notice ) ) . PHP_EOL ) , '<br><hr><br>';
    			}
