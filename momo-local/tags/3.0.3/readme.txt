...
* Changed admin dashicon to money icon
...
* Admins can now set what the text before the form says
* Added store instructions displayed on the thank you page and sent in email to customer 
