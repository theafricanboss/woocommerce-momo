...
> **How we recently went from 5 stars to 2 stars**
>
>> Version 3.0.5 had a bug that crashed some sites but got fixed in 3.0.6
>> The bug was the result of a missing line of code: include_once( ABSPATH . 'wp-admin/includes/plugin.php' ); which got added in 3.0.6
